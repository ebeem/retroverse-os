...
from homelanderscrapers import parse_qs, urljoin, urlparse, urlencode, quote_plus
from homelanderscrapers.modules import cleantitle, client, debrid, log_utils, source_utils, cfscrape
...
class source:
    def __init__(self):
        self.priority = 0
        self.language = ['en']
        self.domains = ['rlsbb.com', 'rlsbb.ru', 'rlsbb.to', 'rlsbb.cc', 'old3.rlsbb.cc', 'old3.rlsbb.ru', 'old3.rlsbb.to', 'rlsbb.unblockit.mov', 'rlsbb.unblockit.nz', 'rlsbb.unblockit.ist', 'rlsbb.unblockit.rsvp']
        self.base_link = custom_base #or 'https://rlsbb.to'
        #self.search_base_link = 'http://search.rlsbb.ru'
        #self.search_cookie = 'search_mode=rlsbb'
        #self.search_link = 'VXBkYXRlZCBCeSBIb21lbGFuZGVyIEFsbCBUaGUgUmVzdCBZb3UgU3RlYWwgSXQgWW91IFN1Y2sgQ29ja3Mu'
        self.aliases = []
