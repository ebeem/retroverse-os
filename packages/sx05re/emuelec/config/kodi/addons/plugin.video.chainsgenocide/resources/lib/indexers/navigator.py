...
class navigator:
    ...
    def tools(self):
        self.addDirectoryItem('[B]chainsgenocide[/B] : Changelog', 'changelog', 'tools.png', 'DefaultAddonProgram.png', isFolder=False)
        self.addDirectoryItem(32043, 'openSettings&query=0.0', 'tools.png', 'DefaultAddonProgram.png', isFolder=False)
        self.addDirectoryItem(32079, 'chainsgenocidescrapersettings', 'icon.png', 'DefaultAddonProgram.png', isFolder=False)
        ...
        self.addDirectoryItem('[B]chainsgenocide[/B] : Cache Functions', 'cacheNavigator', 'tools.png', 'DefaultAddonProgram.png')
        self.addDirectoryItem('[B]chainsgenocide[/B] : Log Functions', 'logNavigator', 'tools.png', 'DefaultAddonProgram.png')
    ...
    def log_functions(self):
        self.addDirectoryItem('[B]chainsgenocide[/B] : View Log', 'viewLog', 'tools.png', 'DefaultAddonProgram.png', isFolder=False)
        self.addDirectoryItem('[B]chainsgenocide[/B] : Upload Log to Pastebin', 'uploadLog', 'tools.png', 'DefaultAddonProgram.png', isFolder=False)
        self.addDirectoryItem('[B]chainsgenocide[/B] : Empty Log', 'emptyLog', 'tools.png', 'DefaultAddonProgram.png', isFolder=False)
