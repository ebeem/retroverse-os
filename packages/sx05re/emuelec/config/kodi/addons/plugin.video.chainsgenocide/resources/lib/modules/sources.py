...
class sources:
    ...
    def getConstants(self):
        self.itemProperty = 'plugin.video.chainsgenocide.container.items'

        self.metaProperty = 'plugin.video.chainsgenocide.container.meta'
        ...
        self.module_name = 'chainsgenocide:'

        if externalEnabled == 'true':
            try:
                import chainsgenocidescrapers
                self.sourceDict += chainsgenocidescrapers.sources()
                self.module_name = 'chainsgenocideScrapers (' + str(control.addon('script.module.chainsgenocidescrapers').getSetting('package.folder')) + ' set):' \
                                   if control.addon('script.module.chainsgenocidescrapers').getSetting('package.folder') != 'chainsgenocidescrapers' else '[COLOR white]chainsgenocide will find your content[/COLOR]'
            except:
                pass
